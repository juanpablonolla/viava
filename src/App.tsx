...
function HomeView({ onNavigate }: { onNavigate: (view: 'home' | 'services') => void }) {
  return (
    <motion.div 
    ...
    >
      ...
      <div className="z-10 flex flex-col items-center w-full max-w-md">
        ...
        <div className="w-full space-y-5 flex flex-col items-center">
          ...
          <button className="w-full max-w-xs bg-white text-[#332b3b] font-bold py-4 rounded-full text-lg shadow-lg hover:scale-105 hover:shadow-xl transition-all duration-300">
            Sobre mi
          </button>
...
function ServicesView({ onNavigate }: { onNavigate: (view: 'home' | 'services') => void }) {
  const services = [
